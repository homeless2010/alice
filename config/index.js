...
module.exports = {
    ...
    NAME: '沐沐', //女朋友备注姓名
    NICKNAME: '沐沐', //女朋友昵称
    MEMORIAL_DAY: '2021/11/02', //你和女朋友的纪念日
    CITY: '西安', //女朋友所在城市（城市名称，不要带“市”）
    SENDDATE: '0 */3 * * * *', //定时发送时间 每天8点06分0秒发送，规则见 /schedule/index.js
    TXAPIKEY: 'd7a84cbb8f6c2b1e5422decfc9ebdc78', //此处须填写个人申请的天行apikey,请替换成自己的 申请地址https://www.tianapi.com/signup.html?source=474284281
